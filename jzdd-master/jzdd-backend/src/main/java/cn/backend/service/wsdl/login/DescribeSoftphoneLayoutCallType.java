...
public class DescribeSoftphoneLayoutCallType  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DescribeSoftphoneLayoutInfoField[] infoFields;

    private java.lang.String name;

    private cn.backend.service.wsdl.login.DescribeSoftphoneScreenPopOption[] screenPopOptions;

    private java.lang.String screenPopsOpenWithin;

    private cn.backend.service.wsdl.login.DescribeSoftphoneLayoutSection[] sections;

    public DescribeSoftphoneLayoutCallType() {
    }

    public DescribeSoftphoneLayoutCallType(
           cn.backend.service.wsdl.login.DescribeSoftphoneLayoutInfoField[] infoFields,
           java.lang.String name,
           cn.backend.service.wsdl.login.DescribeSoftphoneScreenPopOption[] screenPopOptions,
           java.lang.String screenPopsOpenWithin,
           cn.backend.service.wsdl.login.DescribeSoftphoneLayoutSection[] sections) {
     ...
     * @return infoFields
     */
    public cn.backend.service.wsdl.login.DescribeSoftphoneLayoutInfoField[] getInfoFields() {
        return infoFields;
    }
     ...
     * @param infoFields
     */
    public void setInfoFields(cn.backend.service.wsdl.login.DescribeSoftphoneLayoutInfoField[] infoFields) {
        this.infoFields = infoFields;
    }

    public cn.backend.service.wsdl.login.DescribeSoftphoneLayoutInfoField getInfoFields(int i) {
        return this.infoFields[i];
    }

    public void setInfoFields(int i, cn.backend.service.wsdl.login.DescribeSoftphoneLayoutInfoField _value) {
     ...
     */
    public cn.backend.service.wsdl.login.DescribeSoftphoneScreenPopOption[] getScreenPopOptions() {
        return screenPopOptions;
    }
     ...
     */
    public void setScreenPopOptions(cn.backend.service.wsdl.login.DescribeSoftphoneScreenPopOption[] screenPopOptions) {
        this.screenPopOptions = screenPopOptions;
    }

    public cn.backend.service.wsdl.login.DescribeSoftphoneScreenPopOption getScreenPopOptions(int i) {
        return this.screenPopOptions[i];
    }

    public void setScreenPopOptions(int i, cn.backend.service.wsdl.login.DescribeSoftphoneScreenPopOption _value) {
     ...
     * @return sections
     */
    public cn.backend.service.wsdl.login.DescribeSoftphoneLayoutSection[] getSections() {
        return sections;
    }
     ...
     * @param sections
     */
    public void setSections(cn.backend.service.wsdl.login.DescribeSoftphoneLayoutSection[] sections) {
        this.sections = sections;
    }

    public cn.backend.service.wsdl.login.DescribeSoftphoneLayoutSection getSections(int i) {
        return this.sections[i];
    }

    public void setSections(int i, cn.backend.service.wsdl.login.DescribeSoftphoneLayoutSection _value) {
