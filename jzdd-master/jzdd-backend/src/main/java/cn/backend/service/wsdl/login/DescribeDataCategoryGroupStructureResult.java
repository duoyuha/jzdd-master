...
public class DescribeDataCategoryGroupStructureResult  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.DataCategory[] topCategories;
    ...
    public DescribeDataCategoryGroupStructureResult(
           ...
           cn.backend.service.wsdl.login.DataCategory[] topCategories) {
     ...
     */
    public cn.backend.service.wsdl.login.DataCategory[] getTopCategories() {
        return topCategories;
    }
     ...
     * @param topCategories
     */
    public void setTopCategories(cn.backend.service.wsdl.login.DataCategory[] topCategories) {
        this.topCategories = topCategories;
    }

    public cn.backend.service.wsdl.login.DataCategory getTopCategories(int i) {
        return this.topCategories[i];
    }

    public void setTopCategories(int i, cn.backend.service.wsdl.login.DataCategory _value) {
