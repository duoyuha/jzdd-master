...
public class LoginResult  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.GetUserInfoResult userInfo;
    ...
    public LoginResult(
           ...
           cn.backend.service.wsdl.login.GetUserInfoResult userInfo) {
     ...
     * @return userInfo
     */
    public cn.backend.service.wsdl.login.GetUserInfoResult getUserInfo() {
        return userInfo;
    }
     ...
     * @param userInfo
     */
    public void setUserInfo(cn.backend.service.wsdl.login.GetUserInfoResult userInfo) {
        this.userInfo = userInfo;
    }
