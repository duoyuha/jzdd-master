...
public class ListViewColumn  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.OrderByDirection sortDirection;
    ...
    public ListViewColumn(
           ...
           cn.backend.service.wsdl.login.OrderByDirection sortDirection,
    ...
    /**
     * Gets the searchable value for this ListViewColumn.
     * 
     * @return searchable
     */
    ...
    /**
     * Sets the searchable value for this ListViewColumn.
     * 
     * @param searchable
     */
     ...
     */
    public cn.backend.service.wsdl.login.OrderByDirection getSortDirection() {
        return sortDirection;
    }
     ...
     * @param sortDirection
     */
    public void setSortDirection(cn.backend.service.wsdl.login.OrderByDirection sortDirection) {
        this.sortDirection = sortDirection;
    }
