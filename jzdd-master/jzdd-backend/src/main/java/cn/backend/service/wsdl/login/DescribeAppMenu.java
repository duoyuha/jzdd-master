...
public class DescribeAppMenu  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.AppMenuType appMenuType;
    ...
    public DescribeAppMenu(
           cn.backend.service.wsdl.login.AppMenuType appMenuType,
     ...
     * @return appMenuType
     */
    public cn.backend.service.wsdl.login.AppMenuType getAppMenuType() {
        return appMenuType;
    }
     ...
     * @param appMenuType
     */
    public void setAppMenuType(cn.backend.service.wsdl.login.AppMenuType appMenuType) {
        this.appMenuType = appMenuType;
    }
