...
public class GetDeletedResponse  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.GetDeletedResult result;

    public GetDeletedResponse() {
    }

    public GetDeletedResponse(
           cn.backend.service.wsdl.login.GetDeletedResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public cn.backend.service.wsdl.login.GetDeletedResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(cn.backend.service.wsdl.login.GetDeletedResult result) {
        this.result = result;
    }
