...
public class DataCategory  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DataCategory[] childCategories;
    ...
    public DataCategory(
           cn.backend.service.wsdl.login.DataCategory[] childCategories,
     ...
     */
    public cn.backend.service.wsdl.login.DataCategory[] getChildCategories() {
        return childCategories;
    }
     ...
     */
    public void setChildCategories(cn.backend.service.wsdl.login.DataCategory[] childCategories) {
        this.childCategories = childCategories;
    }

    public cn.backend.service.wsdl.login.DataCategory getChildCategories(int i) {
        return this.childCategories[i];
    }

    public void setChildCategories(int i, cn.backend.service.wsdl.login.DataCategory _value) {
