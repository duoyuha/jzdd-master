...
public class ApiFault  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.ExceptionCode exceptionCode;

    private java.lang.String exceptionMessage;

    private cn.backend.service.wsdl.login.ExtendedErrorDetails[] extendedErrorDetails;

    public ApiFault() {
    }

    public ApiFault(
           cn.backend.service.wsdl.login.ExceptionCode exceptionCode,
           java.lang.String exceptionMessage,
           cn.backend.service.wsdl.login.ExtendedErrorDetails[] extendedErrorDetails) {
     ...
     */
    public cn.backend.service.wsdl.login.ExceptionCode getExceptionCode() {
        return exceptionCode;
    }
     ...
     * @param exceptionCode
     */
    public void setExceptionCode(cn.backend.service.wsdl.login.ExceptionCode exceptionCode) {
        this.exceptionCode = exceptionCode;
    }
     ...
     */
    public cn.backend.service.wsdl.login.ExtendedErrorDetails[] getExtendedErrorDetails() {
        return extendedErrorDetails;
    }
     ...
     */
    public void setExtendedErrorDetails(cn.backend.service.wsdl.login.ExtendedErrorDetails[] extendedErrorDetails) {
        this.extendedErrorDetails = extendedErrorDetails;
    }

    public cn.backend.service.wsdl.login.ExtendedErrorDetails getExtendedErrorDetails(int i) {
        return this.extendedErrorDetails[i];
    }

    public void setExtendedErrorDetails(int i, cn.backend.service.wsdl.login.ExtendedErrorDetails _value) {
