...
public class SingleEmailMessage  extends cn.backend.service.wsdl.login.Email  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.EmailFileAttachment[] fileAttachments;

    private java.lang.String htmlBody;

    private java.lang.String inReplyTo;

    private cn.backend.service.wsdl.login.SendEmailOptOutPolicy optOutPolicy;
    ...
    public SingleEmailMessage(
           ...
           cn.backend.service.wsdl.login.EmailPriority emailPriority,
           ...
           cn.backend.service.wsdl.login.EmailFileAttachment[] fileAttachments,
           java.lang.String htmlBody,
           java.lang.String inReplyTo,
           cn.backend.service.wsdl.login.SendEmailOptOutPolicy optOutPolicy,
     ...
     */
    public cn.backend.service.wsdl.login.EmailFileAttachment[] getFileAttachments() {
        return fileAttachments;
    }
     ...
     */
    public void setFileAttachments(cn.backend.service.wsdl.login.EmailFileAttachment[] fileAttachments) {
        this.fileAttachments = fileAttachments;
    }

    public cn.backend.service.wsdl.login.EmailFileAttachment getFileAttachments(int i) {
        return this.fileAttachments[i];
    }

    public void setFileAttachments(int i, cn.backend.service.wsdl.login.EmailFileAttachment _value) {
     ...
     * @return optOutPolicy
     */
    public cn.backend.service.wsdl.login.SendEmailOptOutPolicy getOptOutPolicy() {
        return optOutPolicy;
    }
     ...
     * @param optOutPolicy
     */
    public void setOptOutPolicy(cn.backend.service.wsdl.login.SendEmailOptOutPolicy optOutPolicy) {
        this.optOutPolicy = optOutPolicy;
    }
    ...
    /**
     * Gets the templateName value for this SingleEmailMessage.
     * 
     * @return templateName
     */
    ...
    /**
     * Sets the templateName value for this SingleEmailMessage.
     * 
     * @param templateName
     */
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "templateName"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
