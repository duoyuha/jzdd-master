...
public class DescribeLayoutItem  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.DescribeLayoutComponent[] layoutComponents;
    ...
    public DescribeLayoutItem(
           ...
           cn.backend.service.wsdl.login.DescribeLayoutComponent[] layoutComponents,
           boolean placeholder,
           boolean required) {
     ...
     */
    public cn.backend.service.wsdl.login.DescribeLayoutComponent[] getLayoutComponents() {
        return layoutComponents;
    }
     ...
     */
    public void setLayoutComponents(cn.backend.service.wsdl.login.DescribeLayoutComponent[] layoutComponents) {
        this.layoutComponents = layoutComponents;
    }

    public cn.backend.service.wsdl.login.DescribeLayoutComponent getLayoutComponents(int i) {
        return this.layoutComponents[i];
    }

    public void setLayoutComponents(int i, cn.backend.service.wsdl.login.DescribeLayoutComponent _value) {
