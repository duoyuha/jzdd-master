...
public class ResetPasswordResponse  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.ResetPasswordResult result;

    public ResetPasswordResponse() {
    }

    public ResetPasswordResponse(
           cn.backend.service.wsdl.login.ResetPasswordResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public cn.backend.service.wsdl.login.ResetPasswordResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(cn.backend.service.wsdl.login.ResetPasswordResult result) {
        this.result = result;
    }
