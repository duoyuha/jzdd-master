...
public class SearchResult  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.SearchRecord[] searchRecords;

    private cn.backend.service.wsdl.login.SearchResultsMetadata searchResultsMetadata;
    ...
    public SearchResult(
           ...
           cn.backend.service.wsdl.login.SearchRecord[] searchRecords,
           cn.backend.service.wsdl.login.SearchResultsMetadata searchResultsMetadata) {
     ...
     */
    public cn.backend.service.wsdl.login.SearchRecord[] getSearchRecords() {
        return searchRecords;
    }
     ...
     * @param searchRecords
     */
    public void setSearchRecords(cn.backend.service.wsdl.login.SearchRecord[] searchRecords) {
        this.searchRecords = searchRecords;
    }

    public cn.backend.service.wsdl.login.SearchRecord getSearchRecords(int i) {
        return this.searchRecords[i];
    }

    public void setSearchRecords(int i, cn.backend.service.wsdl.login.SearchRecord _value) {
     ...
     */
    public cn.backend.service.wsdl.login.SearchResultsMetadata getSearchResultsMetadata() {
        return searchResultsMetadata;
    }
     ...
     */
    public void setSearchResultsMetadata(cn.backend.service.wsdl.login.SearchResultsMetadata searchResultsMetadata) {
        this.searchResultsMetadata = searchResultsMetadata;
    }
