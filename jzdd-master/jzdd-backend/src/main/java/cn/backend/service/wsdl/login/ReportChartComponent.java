...
public class ReportChartComponent  extends cn.backend.service.wsdl.login.DescribeLayoutComponent  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.ReportChartSize size;
    ...
    public ReportChartComponent(
           ...
           boolean showTitle,
           cn.backend.service.wsdl.login.ReportChartSize size) {
        super(
            displayLines,
            tabOrder,
            type,
     ...
     * @return size
     */
    public cn.backend.service.wsdl.login.ReportChartSize getSize() {
        return size;
    }
     ...
     * @param size
     */
    public void setSize(cn.backend.service.wsdl.login.ReportChartSize size) {
        this.size = size;
    }
