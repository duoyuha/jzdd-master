...
public class KnowledgeSettings  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.KnowledgeLanguageItem[] languages;
    ...
    public KnowledgeSettings(
           ...
           cn.backend.service.wsdl.login.KnowledgeLanguageItem[] languages) {
     ...
     * @return languages
     */
    public cn.backend.service.wsdl.login.KnowledgeLanguageItem[] getLanguages() {
        return languages;
    }
     ...
     * @param languages
     */
    public void setLanguages(cn.backend.service.wsdl.login.KnowledgeLanguageItem[] languages) {
        this.languages = languages;
    }

    public cn.backend.service.wsdl.login.KnowledgeLanguageItem getLanguages(int i) {
        return this.languages[i];
    }

    public void setLanguages(int i, cn.backend.service.wsdl.login.KnowledgeLanguageItem _value) {
