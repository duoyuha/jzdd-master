...
public class SendEmailResult  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.SendEmailError[] errors;
    ...
    public SendEmailResult(
           cn.backend.service.wsdl.login.SendEmailError[] errors,
           boolean success) {
           this.errors = errors;
     ...
     * @return errors
     */
    public cn.backend.service.wsdl.login.SendEmailError[] getErrors() {
        return errors;
    }
     ...
     * @param errors
     */
    public void setErrors(cn.backend.service.wsdl.login.SendEmailError[] errors) {
        this.errors = errors;
    }

    public cn.backend.service.wsdl.login.SendEmailError getErrors(int i) {
        return this.errors[i];
    }

    public void setErrors(int i, cn.backend.service.wsdl.login.SendEmailError _value) {
