...
public class DescribeGlobalResponse  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DescribeGlobalResult result;

    public DescribeGlobalResponse() {
    }

    public DescribeGlobalResponse(
           cn.backend.service.wsdl.login.DescribeGlobalResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public cn.backend.service.wsdl.login.DescribeGlobalResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(cn.backend.service.wsdl.login.DescribeGlobalResult result) {
        this.result = result;
    }
