...
public class ExecuteListViewResult  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.ListViewRecordColumn[][] records;
    ...
    public ExecuteListViewResult(
           ...
           cn.backend.service.wsdl.login.ListViewRecordColumn[][] records,
           int size) {
     ...
     * @return records
     */
    public cn.backend.service.wsdl.login.ListViewRecordColumn[][] getRecords() {
        return records;
    }
     ...
     * @param records
     */
    public void setRecords(cn.backend.service.wsdl.login.ListViewRecordColumn[][] records) {
        this.records = records;
    }

    public cn.backend.service.wsdl.login.ListViewRecordColumn[] getRecords(int i) {
        return this.records[i];
    }

    public void setRecords(int i, cn.backend.service.wsdl.login.ListViewRecordColumn[] _value) {
