...
@Component
public class SforceServiceLocator extends org.apache.axis.client.Service implements cn.backend.service.wsdl.login.SforceService {
 ...
 */
    ...
    private java.lang.String Soap_address = "https://login.salesforce.com/services/Soap/u/46.0";
    ...
    public cn.backend.service.wsdl.login.Soap_PortType getSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.backend.service.wsdl.login.SoapBindingStub _stub = new cn.backend.service.wsdl.login.SoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.backend.service.wsdl.login.Soap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.backend.service.wsdl.login.SoapBindingStub _stub = new cn.backend.service.wsdl.login.SoapBindingStub(new java.net.URL(Soap_address), this);
                _stub.setPortName(getSoapWSDDServiceName());
                return _stub;
            }
        }
