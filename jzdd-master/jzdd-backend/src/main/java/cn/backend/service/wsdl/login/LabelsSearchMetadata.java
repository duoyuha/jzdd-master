...
public class LabelsSearchMetadata  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.NameValuePair[] entityFieldLabels;
    ...
    public LabelsSearchMetadata(
           cn.backend.service.wsdl.login.NameValuePair[] entityFieldLabels,
     ...
     */
    public cn.backend.service.wsdl.login.NameValuePair[] getEntityFieldLabels() {
        return entityFieldLabels;
    }
     ...
     */
    public void setEntityFieldLabels(cn.backend.service.wsdl.login.NameValuePair[] entityFieldLabels) {
        this.entityFieldLabels = entityFieldLabels;
    }

    public cn.backend.service.wsdl.login.NameValuePair getEntityFieldLabels(int i) {
        return this.entityFieldLabels[i];
    }

    public void setEntityFieldLabels(int i, cn.backend.service.wsdl.login.NameValuePair _value) {
