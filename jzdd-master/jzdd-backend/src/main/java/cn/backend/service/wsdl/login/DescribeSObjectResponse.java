...
public class DescribeSObjectResponse  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DescribeSObjectResult result;

    public DescribeSObjectResponse() {
    }

    public DescribeSObjectResponse(
           cn.backend.service.wsdl.login.DescribeSObjectResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public cn.backend.service.wsdl.login.DescribeSObjectResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(cn.backend.service.wsdl.login.DescribeSObjectResult result) {
        this.result = result;
    }
