...
public class SearchLayoutFieldsDisplayed  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.SearchLayoutField[] fields;
    ...
    public SearchLayoutFieldsDisplayed(
           boolean applicable,
           cn.backend.service.wsdl.login.SearchLayoutField[] fields) {
     ...
     * @return fields
     */
    public cn.backend.service.wsdl.login.SearchLayoutField[] getFields() {
        return fields;
    }
     ...
     * @param fields
     */
    public void setFields(cn.backend.service.wsdl.login.SearchLayoutField[] fields) {
        this.fields = fields;
    }

    public cn.backend.service.wsdl.login.SearchLayoutField getFields(int i) {
        return this.fields[i];
    }

    public void setFields(int i, cn.backend.service.wsdl.login.SearchLayoutField _value) {
