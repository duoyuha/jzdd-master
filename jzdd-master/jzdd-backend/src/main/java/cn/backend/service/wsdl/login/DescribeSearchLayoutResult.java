...
public class DescribeSearchLayoutResult  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.DescribeColumn[] searchColumns;
    ...
    public DescribeSearchLayoutResult(
           ...
           cn.backend.service.wsdl.login.DescribeColumn[] searchColumns) {
     ...
     */
    public cn.backend.service.wsdl.login.DescribeColumn[] getSearchColumns() {
        return searchColumns;
    }
     ...
     * @param searchColumns
     */
    public void setSearchColumns(cn.backend.service.wsdl.login.DescribeColumn[] searchColumns) {
        this.searchColumns = searchColumns;
    }

    public cn.backend.service.wsdl.login.DescribeColumn getSearchColumns(int i) {
        return this.searchColumns[i];
    }

    public void setSearchColumns(int i, cn.backend.service.wsdl.login.DescribeColumn _value) {
