...
public class GetServerTimestampResponse  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.GetServerTimestampResult result;

    public GetServerTimestampResponse() {
    }

    public GetServerTimestampResponse(
           cn.backend.service.wsdl.login.GetServerTimestampResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public cn.backend.service.wsdl.login.GetServerTimestampResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(cn.backend.service.wsdl.login.GetServerTimestampResult result) {
        this.result = result;
    }
