...
public class OwnerChangeOption  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.OwnerChangeOptionType type;
    ...
    public OwnerChangeOption(
           cn.backend.service.wsdl.login.OwnerChangeOptionType type,
           boolean execute) {
           this.type = type;
     ...
     * @return type
     */
    public cn.backend.service.wsdl.login.OwnerChangeOptionType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(cn.backend.service.wsdl.login.OwnerChangeOptionType type) {
        this.type = type;
    }
