...
public class DescribeSoftphoneLayoutSection  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.DescribeSoftphoneLayoutItem[] items;
    ...
    public DescribeSoftphoneLayoutSection(
           ...
           cn.backend.service.wsdl.login.DescribeSoftphoneLayoutItem[] items) {
     ...
     * @return items
     */
    public cn.backend.service.wsdl.login.DescribeSoftphoneLayoutItem[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(cn.backend.service.wsdl.login.DescribeSoftphoneLayoutItem[] items) {
        this.items = items;
    }

    public cn.backend.service.wsdl.login.DescribeSoftphoneLayoutItem getItems(int i) {
        return this.items[i];
    }

    public void setItems(int i, cn.backend.service.wsdl.login.DescribeSoftphoneLayoutItem _value) {
        this.items[i] = _value;
    }
