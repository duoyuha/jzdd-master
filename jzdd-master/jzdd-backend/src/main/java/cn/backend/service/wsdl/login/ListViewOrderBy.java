...
public class ListViewOrderBy  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.OrderByNullsPosition nullsPosition;
    ...
    public ListViewOrderBy(
           ...
           cn.backend.service.wsdl.login.OrderByNullsPosition nullsPosition,
     ...
     */
    public cn.backend.service.wsdl.login.OrderByNullsPosition getNullsPosition() {
        return nullsPosition;
    }
     ...
     * @param nullsPosition
     */
    public void setNullsPosition(cn.backend.service.wsdl.login.OrderByNullsPosition nullsPosition) {
        this.nullsPosition = nullsPosition;
    }
