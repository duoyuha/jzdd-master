...
public class GetUpdatedResponse  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.GetUpdatedResult result;

    public GetUpdatedResponse() {
    }

    public GetUpdatedResponse(
           cn.backend.service.wsdl.login.GetUpdatedResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public cn.backend.service.wsdl.login.GetUpdatedResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(cn.backend.service.wsdl.login.GetUpdatedResult result) {
        this.result = result;
    }
