...
public class DescribeSoqlListViews  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DescribeSoqlListViewParams[] request;

    public DescribeSoqlListViews() {
    }

    public DescribeSoqlListViews(
           cn.backend.service.wsdl.login.DescribeSoqlListViewParams[] request) {
     ...
     * @return request
     */
    public cn.backend.service.wsdl.login.DescribeSoqlListViewParams[] getRequest() {
        return request;
    }
     ...
     * @param request
     */
    public void setRequest(cn.backend.service.wsdl.login.DescribeSoqlListViewParams[] request) {
        this.request = request;
    }
