...
public class DuplicateError  extends cn.backend.service.wsdl.login.Error  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DuplicateResult duplicateResult;
    ...
    public DuplicateError(
           ...
           cn.backend.service.wsdl.login.DuplicateResult duplicateResult) {
        super(
     ...
     */
    public cn.backend.service.wsdl.login.DuplicateResult getDuplicateResult() {
        return duplicateResult;
    }
     ...
     */
    public void setDuplicateResult(cn.backend.service.wsdl.login.DuplicateResult duplicateResult) {
        this.duplicateResult = duplicateResult;
    }
