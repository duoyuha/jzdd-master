...
public class QueryResult  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.SObject[] records;
    ...
    public QueryResult(
           ...
           cn.backend.service.wsdl.login.SObject[] records,
           int size) {
           this.done = done;
     ...
     * @return records
     */
    public cn.backend.service.wsdl.login.SObject[] getRecords() {
        return records;
    }
     ...
     * @param records
     */
    public void setRecords(cn.backend.service.wsdl.login.SObject[] records) {
        this.records = records;
    }

    public cn.backend.service.wsdl.login.SObject getRecords(int i) {
        return this.records[i];
    }

    public void setRecords(int i, cn.backend.service.wsdl.login.SObject _value) {
