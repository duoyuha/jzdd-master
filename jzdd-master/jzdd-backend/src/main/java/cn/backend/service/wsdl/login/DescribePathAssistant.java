...
public class DescribePathAssistant  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.PicklistForRecordType[] picklistsForRecordType;

    private java.lang.String recordTypeId;

    private cn.backend.service.wsdl.login.DescribePathAssistantStep[] steps;
    ...
    public DescribePathAssistant(
           ...
           cn.backend.service.wsdl.login.PicklistForRecordType[] picklistsForRecordType,
           java.lang.String recordTypeId,
           cn.backend.service.wsdl.login.DescribePathAssistantStep[] steps) {
           this.active = active;
     ...
     */
    public cn.backend.service.wsdl.login.PicklistForRecordType[] getPicklistsForRecordType() {
        return picklistsForRecordType;
    }
     ...
     */
    public void setPicklistsForRecordType(cn.backend.service.wsdl.login.PicklistForRecordType[] picklistsForRecordType) {
        this.picklistsForRecordType = picklistsForRecordType;
    }

    public cn.backend.service.wsdl.login.PicklistForRecordType getPicklistsForRecordType(int i) {
        return this.picklistsForRecordType[i];
    }

    public void setPicklistsForRecordType(int i, cn.backend.service.wsdl.login.PicklistForRecordType _value) {
     ...
     * @return steps
     */
    public cn.backend.service.wsdl.login.DescribePathAssistantStep[] getSteps() {
        return steps;
    }
     ...
     * @param steps
     */
    public void setSteps(cn.backend.service.wsdl.login.DescribePathAssistantStep[] steps) {
        this.steps = steps;
    }

    public cn.backend.service.wsdl.login.DescribePathAssistantStep getSteps(int i) {
        return this.steps[i];
    }

    public void setSteps(int i, cn.backend.service.wsdl.login.DescribePathAssistantStep _value) {
        this.steps[i] = _value;
    }
