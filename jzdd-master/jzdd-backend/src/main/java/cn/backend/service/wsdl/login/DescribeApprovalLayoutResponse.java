...
public class DescribeApprovalLayoutResponse  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DescribeApprovalLayout[] result;

    public DescribeApprovalLayoutResponse() {
    }

    public DescribeApprovalLayoutResponse(
           cn.backend.service.wsdl.login.DescribeApprovalLayout[] result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public cn.backend.service.wsdl.login.DescribeApprovalLayout[] getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(cn.backend.service.wsdl.login.DescribeApprovalLayout[] result) {
        this.result = result;
    }
