...
public class DescribeGlobalResult  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.DescribeGlobalSObjectResult[] sobjects;
    ...
    public DescribeGlobalResult(
           ...
           int maxBatchSize,
           cn.backend.service.wsdl.login.DescribeGlobalSObjectResult[] sobjects) {
     ...
     * @return sobjects
     */
    public cn.backend.service.wsdl.login.DescribeGlobalSObjectResult[] getSobjects() {
        return sobjects;
    }
     ...
     * @param sobjects
     */
    public void setSobjects(cn.backend.service.wsdl.login.DescribeGlobalSObjectResult[] sobjects) {
        this.sobjects = sobjects;
    }

    public cn.backend.service.wsdl.login.DescribeGlobalSObjectResult getSobjects(int i) {
        return this.sobjects[i];
    }

    public void setSobjects(int i, cn.backend.service.wsdl.login.DescribeGlobalSObjectResult _value) {
