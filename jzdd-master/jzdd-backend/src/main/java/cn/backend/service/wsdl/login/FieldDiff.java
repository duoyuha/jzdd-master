...
public class FieldDiff  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DifferenceType difference;
    ...
    public FieldDiff(
           cn.backend.service.wsdl.login.DifferenceType difference,
     ...
     * @return difference
     */
    public cn.backend.service.wsdl.login.DifferenceType getDifference() {
        return difference;
    }
     ...
     * @param difference
     */
    public void setDifference(cn.backend.service.wsdl.login.DifferenceType difference) {
        this.difference = difference;
    }
