...
public class DescribeSoftphoneLayoutResponse  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DescribeSoftphoneLayoutResult result;

    public DescribeSoftphoneLayoutResponse() {
    }

    public DescribeSoftphoneLayoutResponse(
           cn.backend.service.wsdl.login.DescribeSoftphoneLayoutResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public cn.backend.service.wsdl.login.DescribeSoftphoneLayoutResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(cn.backend.service.wsdl.login.DescribeSoftphoneLayoutResult result) {
        this.result = result;
    }
