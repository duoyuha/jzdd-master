...
public class LoginResponse  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.LoginResult result;

    public LoginResponse() {
    }

    public LoginResponse(
           cn.backend.service.wsdl.login.LoginResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public cn.backend.service.wsdl.login.LoginResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(cn.backend.service.wsdl.login.LoginResult result) {
        this.result = result;
    }
