...
public class DescribeNounResult  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.NameCaseValue[] caseValues;

    private java.lang.String developerName;

    private cn.backend.service.wsdl.login.Gender gender;

    private java.lang.String name;

    private java.lang.String pluralAlias;

    private cn.backend.service.wsdl.login.StartsWith startsWith;

    public DescribeNounResult() {
    }

    public DescribeNounResult(
           cn.backend.service.wsdl.login.NameCaseValue[] caseValues,
           java.lang.String developerName,
           cn.backend.service.wsdl.login.Gender gender,
           java.lang.String name,
           java.lang.String pluralAlias,
           cn.backend.service.wsdl.login.StartsWith startsWith) {
     ...
     * @return caseValues
     */
    public cn.backend.service.wsdl.login.NameCaseValue[] getCaseValues() {
        return caseValues;
    }
     ...
     * @param caseValues
     */
    public void setCaseValues(cn.backend.service.wsdl.login.NameCaseValue[] caseValues) {
        this.caseValues = caseValues;
    }

    public cn.backend.service.wsdl.login.NameCaseValue getCaseValues(int i) {
        return this.caseValues[i];
    }

    public void setCaseValues(int i, cn.backend.service.wsdl.login.NameCaseValue _value) {
     ...
     * @return gender
     */
    public cn.backend.service.wsdl.login.Gender getGender() {
        return gender;
    }
     ...
     * @param gender
     */
    public void setGender(cn.backend.service.wsdl.login.Gender gender) {
        this.gender = gender;
    }
     ...
     * @return startsWith
     */
    public cn.backend.service.wsdl.login.StartsWith getStartsWith() {
        return startsWith;
    }
     ...
     * @param startsWith
     */
    public void setStartsWith(cn.backend.service.wsdl.login.StartsWith startsWith) {
        this.startsWith = startsWith;
    }
