...
public class SoqlSubQueryCondition  extends cn.backend.service.wsdl.login.SoqlWhereCondition  implements java.io.Serializable {
    private java.lang.String field;

    private cn.backend.service.wsdl.login.SoqlOperator operator;
    ...
    public SoqlSubQueryCondition(
           ...
           cn.backend.service.wsdl.login.SoqlOperator operator,
     ...
     * @return operator
     */
    public cn.backend.service.wsdl.login.SoqlOperator getOperator() {
        return operator;
    }
     ...
     * @param operator
     */
    public void setOperator(cn.backend.service.wsdl.login.SoqlOperator operator) {
        this.operator = operator;
    }
