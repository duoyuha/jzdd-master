...
public class GetDeletedResult  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DeletedRecord[] deletedRecords;
    ...
    public GetDeletedResult(
           cn.backend.service.wsdl.login.DeletedRecord[] deletedRecords,
     ...
     */
    public cn.backend.service.wsdl.login.DeletedRecord[] getDeletedRecords() {
        return deletedRecords;
    }
     ...
     */
    public void setDeletedRecords(cn.backend.service.wsdl.login.DeletedRecord[] deletedRecords) {
        this.deletedRecords = deletedRecords;
    }

    public cn.backend.service.wsdl.login.DeletedRecord getDeletedRecords(int i) {
        return this.deletedRecords[i];
    }

    public void setDeletedRecords(int i, cn.backend.service.wsdl.login.DeletedRecord _value) {
