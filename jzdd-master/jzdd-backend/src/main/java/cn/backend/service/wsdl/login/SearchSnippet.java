...
public class SearchSnippet  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.NameValuePair[] wholeFields;
    ...
    public SearchSnippet(
           ...
           cn.backend.service.wsdl.login.NameValuePair[] wholeFields) {
           this.text = text;
     ...
     * @return wholeFields
     */
    public cn.backend.service.wsdl.login.NameValuePair[] getWholeFields() {
        return wholeFields;
    }
     ...
     * @param wholeFields
     */
    public void setWholeFields(cn.backend.service.wsdl.login.NameValuePair[] wholeFields) {
        this.wholeFields = wholeFields;
    }

    public cn.backend.service.wsdl.login.NameValuePair getWholeFields(int i) {
        return this.wholeFields[i];
    }

    public void setWholeFields(int i, cn.backend.service.wsdl.login.NameValuePair _value) {
