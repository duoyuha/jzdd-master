...
public class QueryMoreResponse  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.QueryResult result;

    public QueryMoreResponse() {
    }

    public QueryMoreResponse(
           cn.backend.service.wsdl.login.QueryResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public cn.backend.service.wsdl.login.QueryResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(cn.backend.service.wsdl.login.QueryResult result) {
        this.result = result;
    }
