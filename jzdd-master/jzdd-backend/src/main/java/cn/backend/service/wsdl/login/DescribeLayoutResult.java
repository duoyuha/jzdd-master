...
public class DescribeLayoutResult  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DescribeLayout[] layouts;

    private cn.backend.service.wsdl.login.RecordTypeMapping[] recordTypeMappings;
    ...
    public DescribeLayoutResult(
           cn.backend.service.wsdl.login.DescribeLayout[] layouts,
           cn.backend.service.wsdl.login.RecordTypeMapping[] recordTypeMappings,
     ...
     * @return layouts
     */
    public cn.backend.service.wsdl.login.DescribeLayout[] getLayouts() {
        return layouts;
    }
     ...
     * @param layouts
     */
    public void setLayouts(cn.backend.service.wsdl.login.DescribeLayout[] layouts) {
        this.layouts = layouts;
    }

    public cn.backend.service.wsdl.login.DescribeLayout getLayouts(int i) {
        return this.layouts[i];
    }

    public void setLayouts(int i, cn.backend.service.wsdl.login.DescribeLayout _value) {
     ...
     */
    public cn.backend.service.wsdl.login.RecordTypeMapping[] getRecordTypeMappings() {
        return recordTypeMappings;
    }
     ...
     */
    public void setRecordTypeMappings(cn.backend.service.wsdl.login.RecordTypeMapping[] recordTypeMappings) {
        this.recordTypeMappings = recordTypeMappings;
    }

    public cn.backend.service.wsdl.login.RecordTypeMapping getRecordTypeMappings(int i) {
        return this.recordTypeMappings[i];
    }

    public void setRecordTypeMappings(int i, cn.backend.service.wsdl.login.RecordTypeMapping _value) {
