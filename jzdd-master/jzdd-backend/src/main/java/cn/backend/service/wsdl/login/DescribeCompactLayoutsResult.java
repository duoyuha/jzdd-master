...
public class DescribeCompactLayoutsResult  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DescribeCompactLayout[] compactLayouts;

    private java.lang.String defaultCompactLayoutId;

    private cn.backend.service.wsdl.login.RecordTypeCompactLayoutMapping[] recordTypeCompactLayoutMappings;

    public DescribeCompactLayoutsResult() {
    }

    public DescribeCompactLayoutsResult(
           cn.backend.service.wsdl.login.DescribeCompactLayout[] compactLayouts,
           java.lang.String defaultCompactLayoutId,
           cn.backend.service.wsdl.login.RecordTypeCompactLayoutMapping[] recordTypeCompactLayoutMappings) {
     ...
     */
    public cn.backend.service.wsdl.login.DescribeCompactLayout[] getCompactLayouts() {
        return compactLayouts;
    }
     ...
     */
    public void setCompactLayouts(cn.backend.service.wsdl.login.DescribeCompactLayout[] compactLayouts) {
        this.compactLayouts = compactLayouts;
    }

    public cn.backend.service.wsdl.login.DescribeCompactLayout getCompactLayouts(int i) {
        return this.compactLayouts[i];
    }

    public void setCompactLayouts(int i, cn.backend.service.wsdl.login.DescribeCompactLayout _value) {
     ...
     */
    public cn.backend.service.wsdl.login.RecordTypeCompactLayoutMapping[] getRecordTypeCompactLayoutMappings() {
        return recordTypeCompactLayoutMappings;
    }
     ...
     */
    public void setRecordTypeCompactLayoutMappings(cn.backend.service.wsdl.login.RecordTypeCompactLayoutMapping[] recordTypeCompactLayoutMappings) {
        this.recordTypeCompactLayoutMappings = recordTypeCompactLayoutMappings;
    }

    public cn.backend.service.wsdl.login.RecordTypeCompactLayoutMapping getRecordTypeCompactLayoutMappings(int i) {
        return this.recordTypeCompactLayoutMappings[i];
    }

    public void setRecordTypeCompactLayoutMappings(int i, cn.backend.service.wsdl.login.RecordTypeCompactLayoutMapping _value) {
