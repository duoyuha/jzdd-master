...
public class DescribeCompactLayout  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DescribeLayoutButton[] actions;

    private cn.backend.service.wsdl.login.DescribeLayoutItem[] fieldItems;

    private java.lang.String id;

    private cn.backend.service.wsdl.login.DescribeLayoutItem[] imageItems;
    ...
    public DescribeCompactLayout(
           cn.backend.service.wsdl.login.DescribeLayoutButton[] actions,
           cn.backend.service.wsdl.login.DescribeLayoutItem[] fieldItems,
           java.lang.String id,
           cn.backend.service.wsdl.login.DescribeLayoutItem[] imageItems,
     ...
     * @return actions
     */
    public cn.backend.service.wsdl.login.DescribeLayoutButton[] getActions() {
        return actions;
    }
     ...
     * @param actions
     */
    public void setActions(cn.backend.service.wsdl.login.DescribeLayoutButton[] actions) {
        this.actions = actions;
    }

    public cn.backend.service.wsdl.login.DescribeLayoutButton getActions(int i) {
        return this.actions[i];
    }

    public void setActions(int i, cn.backend.service.wsdl.login.DescribeLayoutButton _value) {
     ...
     * @return fieldItems
     */
    public cn.backend.service.wsdl.login.DescribeLayoutItem[] getFieldItems() {
        return fieldItems;
    }
     ...
     * @param fieldItems
     */
    public void setFieldItems(cn.backend.service.wsdl.login.DescribeLayoutItem[] fieldItems) {
        this.fieldItems = fieldItems;
    }

    public cn.backend.service.wsdl.login.DescribeLayoutItem getFieldItems(int i) {
        return this.fieldItems[i];
    }

    public void setFieldItems(int i, cn.backend.service.wsdl.login.DescribeLayoutItem _value) {
     ...
     * @return imageItems
     */
    public cn.backend.service.wsdl.login.DescribeLayoutItem[] getImageItems() {
        return imageItems;
    }
     ...
     * @param imageItems
     */
    public void setImageItems(cn.backend.service.wsdl.login.DescribeLayoutItem[] imageItems) {
        this.imageItems = imageItems;
    }

    public cn.backend.service.wsdl.login.DescribeLayoutItem getImageItems(int i) {
        return this.imageItems[i];
    }

    public void setImageItems(int i, cn.backend.service.wsdl.login.DescribeLayoutItem _value) {
