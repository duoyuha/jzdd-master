...
public class DuplicateResult  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.MatchResult[] matchResults;
    ...
    public DuplicateResult(
           ...
           cn.backend.service.wsdl.login.MatchResult[] matchResults) {
     ...
     * @return matchResults
     */
    public cn.backend.service.wsdl.login.MatchResult[] getMatchResults() {
        return matchResults;
    }
     ...
     * @param matchResults
     */
    public void setMatchResults(cn.backend.service.wsdl.login.MatchResult[] matchResults) {
        this.matchResults = matchResults;
    }

    public cn.backend.service.wsdl.login.MatchResult getMatchResults(int i) {
        return this.matchResults[i];
    }

    public void setMatchResults(int i, cn.backend.service.wsdl.login.MatchResult _value) {
