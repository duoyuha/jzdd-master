...
public class DescribeDataCategoryGroupStructures  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DataCategoryGroupSobjectTypePair[] pairs;
    ...
    public DescribeDataCategoryGroupStructures(
           cn.backend.service.wsdl.login.DataCategoryGroupSobjectTypePair[] pairs,
     ...
     * @return pairs
     */
    public cn.backend.service.wsdl.login.DataCategoryGroupSobjectTypePair[] getPairs() {
        return pairs;
    }
     ...
     * @param pairs
     */
    public void setPairs(cn.backend.service.wsdl.login.DataCategoryGroupSobjectTypePair[] pairs) {
        this.pairs = pairs;
    }

    public cn.backend.service.wsdl.login.DataCategoryGroupSobjectTypePair getPairs(int i) {
        return this.pairs[i];
    }

    public void setPairs(int i, cn.backend.service.wsdl.login.DataCategoryGroupSobjectTypePair _value) {
        this.pairs[i] = _value;
    }
