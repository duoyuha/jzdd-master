...
public class ExtendedErrorDetails  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    private cn.backend.service.wsdl.login.ExtendedErrorCode extendedErrorCode;
    ...
    public ExtendedErrorDetails(
           cn.backend.service.wsdl.login.ExtendedErrorCode extendedErrorCode,
     ...
     */
    public cn.backend.service.wsdl.login.ExtendedErrorCode getExtendedErrorCode() {
        return extendedErrorCode;
    }
     ...
     */
    public void setExtendedErrorCode(cn.backend.service.wsdl.login.ExtendedErrorCode extendedErrorCode) {
        this.extendedErrorCode = extendedErrorCode;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:partner.soap.sforce.com", "ExtendedErrorCode"));
