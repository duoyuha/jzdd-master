...
public class Upsert  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.SObject[] sObjects;
    ...
    public Upsert(
           ...
           cn.backend.service.wsdl.login.SObject[] sObjects) {
     ...
     * @return sObjects
     */
    public cn.backend.service.wsdl.login.SObject[] getSObjects() {
        return sObjects;
    }
     ...
     * @param sObjects
     */
    public void setSObjects(cn.backend.service.wsdl.login.SObject[] sObjects) {
        this.sObjects = sObjects;
    }

    public cn.backend.service.wsdl.login.SObject getSObjects(int i) {
        return this.sObjects[i];
    }

    public void setSObjects(int i, cn.backend.service.wsdl.login.SObject _value) {
