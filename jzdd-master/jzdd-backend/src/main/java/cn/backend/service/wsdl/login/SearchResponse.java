...
public class SearchResponse  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.SearchResult result;

    public SearchResponse() {
    }

    public SearchResponse(
           cn.backend.service.wsdl.login.SearchResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public cn.backend.service.wsdl.login.SearchResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(cn.backend.service.wsdl.login.SearchResult result) {
        this.result = result;
    }
