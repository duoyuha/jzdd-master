...
public class RelatedList  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.ShareAccessLevel accessLevelRequiredForCreate;

    private cn.backend.service.wsdl.login.DescribeLayoutButton[] buttons;

    private cn.backend.service.wsdl.login.RelatedListColumn[] columns;
    ...
    private cn.backend.service.wsdl.login.RelatedListSort[] sort;

    public RelatedList() {
    }

    public RelatedList(
           cn.backend.service.wsdl.login.ShareAccessLevel accessLevelRequiredForCreate,
           cn.backend.service.wsdl.login.DescribeLayoutButton[] buttons,
           cn.backend.service.wsdl.login.RelatedListColumn[] columns,
           boolean custom,
           ...
           cn.backend.service.wsdl.login.RelatedListSort[] sort) {
     ...
     */
    public cn.backend.service.wsdl.login.ShareAccessLevel getAccessLevelRequiredForCreate() {
        return accessLevelRequiredForCreate;
    }
     ...
     */
    public void setAccessLevelRequiredForCreate(cn.backend.service.wsdl.login.ShareAccessLevel accessLevelRequiredForCreate) {
        this.accessLevelRequiredForCreate = accessLevelRequiredForCreate;
    }
     ...
     * @return buttons
     */
    public cn.backend.service.wsdl.login.DescribeLayoutButton[] getButtons() {
        return buttons;
    }
     ...
     * @param buttons
     */
    public void setButtons(cn.backend.service.wsdl.login.DescribeLayoutButton[] buttons) {
        this.buttons = buttons;
    }

    public cn.backend.service.wsdl.login.DescribeLayoutButton getButtons(int i) {
        return this.buttons[i];
    }

    public void setButtons(int i, cn.backend.service.wsdl.login.DescribeLayoutButton _value) {
     ...
     * @return columns
     */
    public cn.backend.service.wsdl.login.RelatedListColumn[] getColumns() {
        return columns;
    }
     ...
     * @param columns
     */
    public void setColumns(cn.backend.service.wsdl.login.RelatedListColumn[] columns) {
        this.columns = columns;
    }

    public cn.backend.service.wsdl.login.RelatedListColumn getColumns(int i) {
        return this.columns[i];
    }

    public void setColumns(int i, cn.backend.service.wsdl.login.RelatedListColumn _value) {
     ...
     * @return sort
     */
    public cn.backend.service.wsdl.login.RelatedListSort[] getSort() {
        return sort;
    }
     ...
     * @param sort
     */
    public void setSort(cn.backend.service.wsdl.login.RelatedListSort[] sort) {
        this.sort = sort;
    }

    public cn.backend.service.wsdl.login.RelatedListSort getSort(int i) {
        return this.sort[i];
    }

    public void setSort(int i, cn.backend.service.wsdl.login.RelatedListSort _value) {
        this.sort[i] = _value;
    }
