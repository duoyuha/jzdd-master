...
public class DescribeLayoutResponse  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DescribeLayoutResult result;

    public DescribeLayoutResponse() {
    }

    public DescribeLayoutResponse(
           cn.backend.service.wsdl.login.DescribeLayoutResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public cn.backend.service.wsdl.login.DescribeLayoutResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(cn.backend.service.wsdl.login.DescribeLayoutResult result) {
        this.result = result;
    }
