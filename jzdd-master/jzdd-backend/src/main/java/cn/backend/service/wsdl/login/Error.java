...
public class Error  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.StatusCode statusCode;
    ...
    public Error(
           ...
           cn.backend.service.wsdl.login.StatusCode statusCode) {
     ...
     * @return statusCode
     */
    public cn.backend.service.wsdl.login.StatusCode getStatusCode() {
        return statusCode;
    }
     ...
     * @param statusCode
     */
    public void setStatusCode(cn.backend.service.wsdl.login.StatusCode statusCode) {
        this.statusCode = statusCode;
    }
