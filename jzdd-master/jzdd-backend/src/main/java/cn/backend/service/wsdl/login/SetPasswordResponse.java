...
public class SetPasswordResponse  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.SetPasswordResult result;

    public SetPasswordResponse() {
    }

    public SetPasswordResponse(
           cn.backend.service.wsdl.login.SetPasswordResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public cn.backend.service.wsdl.login.SetPasswordResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(cn.backend.service.wsdl.login.SetPasswordResult result) {
        this.result = result;
    }
