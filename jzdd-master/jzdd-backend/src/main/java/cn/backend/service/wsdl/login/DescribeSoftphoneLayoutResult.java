...
public class DescribeSoftphoneLayoutResult  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DescribeSoftphoneLayoutCallType[] callTypes;
    ...
    public DescribeSoftphoneLayoutResult(
           cn.backend.service.wsdl.login.DescribeSoftphoneLayoutCallType[] callTypes,
           java.lang.String id,
     ...
     * @return callTypes
     */
    public cn.backend.service.wsdl.login.DescribeSoftphoneLayoutCallType[] getCallTypes() {
        return callTypes;
    }
     ...
     * @param callTypes
     */
    public void setCallTypes(cn.backend.service.wsdl.login.DescribeSoftphoneLayoutCallType[] callTypes) {
        this.callTypes = callTypes;
    }

    public cn.backend.service.wsdl.login.DescribeSoftphoneLayoutCallType getCallTypes(int i) {
        return this.callTypes[i];
    }

    public void setCallTypes(int i, cn.backend.service.wsdl.login.DescribeSoftphoneLayoutCallType _value) {
