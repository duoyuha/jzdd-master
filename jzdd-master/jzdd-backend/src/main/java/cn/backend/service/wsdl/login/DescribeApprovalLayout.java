...
public class DescribeApprovalLayout  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.DescribeLayoutItem[] layoutItems;
    ...
    public DescribeApprovalLayout(
           ...
           cn.backend.service.wsdl.login.DescribeLayoutItem[] layoutItems,
     ...
     * @return layoutItems
     */
    public cn.backend.service.wsdl.login.DescribeLayoutItem[] getLayoutItems() {
        return layoutItems;
    }
     ...
     * @param layoutItems
     */
    public void setLayoutItems(cn.backend.service.wsdl.login.DescribeLayoutItem[] layoutItems) {
        this.layoutItems = layoutItems;
    }

    public cn.backend.service.wsdl.login.DescribeLayoutItem getLayoutItems(int i) {
        return this.layoutItems[i];
    }

    public void setLayoutItems(int i, cn.backend.service.wsdl.login.DescribeLayoutItem _value) {
