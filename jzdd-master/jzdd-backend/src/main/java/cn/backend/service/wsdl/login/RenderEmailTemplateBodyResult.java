...
public class RenderEmailTemplateBodyResult  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.RenderEmailTemplateError[] errors;
    ...
    public RenderEmailTemplateBodyResult(
           cn.backend.service.wsdl.login.RenderEmailTemplateError[] errors,
     ...
     * @return errors
     */
    public cn.backend.service.wsdl.login.RenderEmailTemplateError[] getErrors() {
        return errors;
    }
     ...
     * @param errors
     */
    public void setErrors(cn.backend.service.wsdl.login.RenderEmailTemplateError[] errors) {
        this.errors = errors;
    }

    public cn.backend.service.wsdl.login.RenderEmailTemplateError getErrors(int i) {
        return this.errors[i];
    }

    public void setErrors(int i, cn.backend.service.wsdl.login.RenderEmailTemplateError _value) {
