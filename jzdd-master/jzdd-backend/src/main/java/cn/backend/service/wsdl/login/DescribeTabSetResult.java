...
public class DescribeTabSetResult  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.DescribeTab[] tabs;
    ...
    public DescribeTabSetResult(
           ...
           cn.backend.service.wsdl.login.DescribeTab[] tabs) {
     ...
     * @return tabs
     */
    public cn.backend.service.wsdl.login.DescribeTab[] getTabs() {
        return tabs;
    }
     ...
     * @param tabs
     */
    public void setTabs(cn.backend.service.wsdl.login.DescribeTab[] tabs) {
        this.tabs = tabs;
    }

    public cn.backend.service.wsdl.login.DescribeTab getTabs(int i) {
        return this.tabs[i];
    }

    public void setTabs(int i, cn.backend.service.wsdl.login.DescribeTab _value) {
        this.tabs[i] = _value;
    }
