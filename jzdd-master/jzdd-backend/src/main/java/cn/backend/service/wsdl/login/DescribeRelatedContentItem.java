...
public class DescribeRelatedContentItem  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DescribeLayoutItem describeLayoutItem;

    public DescribeRelatedContentItem() {
    }

    public DescribeRelatedContentItem(
           cn.backend.service.wsdl.login.DescribeLayoutItem describeLayoutItem) {
     ...
     */
    public cn.backend.service.wsdl.login.DescribeLayoutItem getDescribeLayoutItem() {
        return describeLayoutItem;
    }
     ...
     */
    public void setDescribeLayoutItem(cn.backend.service.wsdl.login.DescribeLayoutItem describeLayoutItem) {
        this.describeLayoutItem = describeLayoutItem;
    }
