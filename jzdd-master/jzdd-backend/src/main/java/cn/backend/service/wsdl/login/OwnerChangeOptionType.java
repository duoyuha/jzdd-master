...
public class OwnerChangeOptionType implements java.io.Serializable {
    ...
    public static final java.lang.String _TransferOwnedClosedOpportunities = "TransferOwnedClosedOpportunities";
    public static final java.lang.String _TransferOwnedOpenCases = "TransferOwnedOpenCases";
    public static final java.lang.String _TransferAllOwnedCases = "TransferAllOwnedCases";
    ...
    public static final java.lang.String _KeepAccountTeam = "KeepAccountTeam";
    public static final java.lang.String _KeepSalesTeam = "KeepSalesTeam";
    public static final java.lang.String _KeepSalesTeamGrantCurrentOwnerReadWriteAccess = "KeepSalesTeamGrantCurrentOwnerReadWriteAccess";
    ...
    public static final OwnerChangeOptionType TransferOwnedClosedOpportunities = new OwnerChangeOptionType(_TransferOwnedClosedOpportunities);
    public static final OwnerChangeOptionType TransferOwnedOpenCases = new OwnerChangeOptionType(_TransferOwnedOpenCases);
    public static final OwnerChangeOptionType TransferAllOwnedCases = new OwnerChangeOptionType(_TransferAllOwnedCases);
    ...
    public static final OwnerChangeOptionType KeepAccountTeam = new OwnerChangeOptionType(_KeepAccountTeam);
    public static final OwnerChangeOptionType KeepSalesTeam = new OwnerChangeOptionType(_KeepSalesTeam);
    public static final OwnerChangeOptionType KeepSalesTeamGrantCurrentOwnerReadWriteAccess = new OwnerChangeOptionType(_KeepSalesTeamGrantCurrentOwnerReadWriteAccess);
