...
public class SoqlNotCondition  extends cn.backend.service.wsdl.login.SoqlWhereCondition  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.SoqlWhereCondition condition;

    public SoqlNotCondition() {
    }

    public SoqlNotCondition(
           cn.backend.service.wsdl.login.SoqlWhereCondition condition) {
     ...
     * @return condition
     */
    public cn.backend.service.wsdl.login.SoqlWhereCondition getCondition() {
        return condition;
    }
     ...
     * @param condition
     */
    public void setCondition(cn.backend.service.wsdl.login.SoqlWhereCondition condition) {
        this.condition = condition;
    }
