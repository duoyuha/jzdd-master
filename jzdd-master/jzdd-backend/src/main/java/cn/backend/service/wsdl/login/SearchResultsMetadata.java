...
public class SearchResultsMetadata  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.LabelsSearchMetadata[] entityLabelMetadata;

    private cn.backend.service.wsdl.login.EntitySearchMetadata[] entityMetadata;

    public SearchResultsMetadata() {
    }

    public SearchResultsMetadata(
           cn.backend.service.wsdl.login.LabelsSearchMetadata[] entityLabelMetadata,
           cn.backend.service.wsdl.login.EntitySearchMetadata[] entityMetadata) {
     ...
     */
    public cn.backend.service.wsdl.login.LabelsSearchMetadata[] getEntityLabelMetadata() {
        return entityLabelMetadata;
    }
     ...
     */
    public void setEntityLabelMetadata(cn.backend.service.wsdl.login.LabelsSearchMetadata[] entityLabelMetadata) {
        this.entityLabelMetadata = entityLabelMetadata;
    }

    public cn.backend.service.wsdl.login.LabelsSearchMetadata getEntityLabelMetadata(int i) {
        return this.entityLabelMetadata[i];
    }

    public void setEntityLabelMetadata(int i, cn.backend.service.wsdl.login.LabelsSearchMetadata _value) {
     ...
     */
    public cn.backend.service.wsdl.login.EntitySearchMetadata[] getEntityMetadata() {
        return entityMetadata;
    }
     ...
     */
    public void setEntityMetadata(cn.backend.service.wsdl.login.EntitySearchMetadata[] entityMetadata) {
        this.entityMetadata = entityMetadata;
    }

    public cn.backend.service.wsdl.login.EntitySearchMetadata getEntityMetadata(int i) {
        return this.entityMetadata[i];
    }

    public void setEntityMetadata(int i, cn.backend.service.wsdl.login.EntitySearchMetadata _value) {
