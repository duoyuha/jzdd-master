...
public class DescribeSObjectListViews  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.ListViewIsSoqlCompatible isSoqlCompatible;
    ...
    public DescribeSObjectListViews(
           ...
           boolean recentsOnly,
           cn.backend.service.wsdl.login.ListViewIsSoqlCompatible isSoqlCompatible,
           int limit,
           int offset) {
     ...
     */
    public cn.backend.service.wsdl.login.ListViewIsSoqlCompatible getIsSoqlCompatible() {
        return isSoqlCompatible;
    }
     ...
     */
    public void setIsSoqlCompatible(cn.backend.service.wsdl.login.ListViewIsSoqlCompatible isSoqlCompatible) {
        this.isSoqlCompatible = isSoqlCompatible;
    }
