...
public class DebuggingHeader  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.LogInfo[] categories;

    private cn.backend.service.wsdl.login.DebugLevel debugLevel;

    public DebuggingHeader() {
    }

    public DebuggingHeader(
           cn.backend.service.wsdl.login.LogInfo[] categories,
           cn.backend.service.wsdl.login.DebugLevel debugLevel) {
     ...
     * @return categories
     */
    public cn.backend.service.wsdl.login.LogInfo[] getCategories() {
        return categories;
    }
     ...
     * @param categories
     */
    public void setCategories(cn.backend.service.wsdl.login.LogInfo[] categories) {
        this.categories = categories;
    }

    public cn.backend.service.wsdl.login.LogInfo getCategories(int i) {
        return this.categories[i];
    }

    public void setCategories(int i, cn.backend.service.wsdl.login.LogInfo _value) {
     ...
     * @return debugLevel
     */
    public cn.backend.service.wsdl.login.DebugLevel getDebugLevel() {
        return debugLevel;
    }
     ...
     * @param debugLevel
     */
    public void setDebugLevel(cn.backend.service.wsdl.login.DebugLevel debugLevel) {
        this.debugLevel = debugLevel;
    }
