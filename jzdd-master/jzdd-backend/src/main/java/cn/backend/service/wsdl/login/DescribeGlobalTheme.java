...
public class DescribeGlobalTheme  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DescribeGlobalResult global;

    private cn.backend.service.wsdl.login.DescribeThemeItem[] theme;

    public DescribeGlobalTheme() {
    }

    public DescribeGlobalTheme(
           cn.backend.service.wsdl.login.DescribeGlobalResult global,
           cn.backend.service.wsdl.login.DescribeThemeItem[] theme) {
           this.global = global;
           this.theme = theme;
    }
     ...
     * @return global
     */
    public cn.backend.service.wsdl.login.DescribeGlobalResult getGlobal() {
        return global;
    }
     ...
     * @param global
     */
    public void setGlobal(cn.backend.service.wsdl.login.DescribeGlobalResult global) {
        this.global = global;
    }
     ...
     * @return theme
     */
    public cn.backend.service.wsdl.login.DescribeThemeItem[] getTheme() {
        return theme;
    }
     ...
     * @param theme
     */
    public void setTheme(cn.backend.service.wsdl.login.DescribeThemeItem[] theme) {
        this.theme = theme;
    }
