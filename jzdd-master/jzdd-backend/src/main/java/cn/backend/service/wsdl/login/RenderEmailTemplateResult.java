...
public class RenderEmailTemplateResult  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.RenderEmailTemplateBodyResult[] bodyResults;
    ...
    public RenderEmailTemplateResult(
           cn.backend.service.wsdl.login.RenderEmailTemplateBodyResult[] bodyResults,
     ...
     * @return bodyResults
     */
    public cn.backend.service.wsdl.login.RenderEmailTemplateBodyResult[] getBodyResults() {
        return bodyResults;
    }
     ...
     * @param bodyResults
     */
    public void setBodyResults(cn.backend.service.wsdl.login.RenderEmailTemplateBodyResult[] bodyResults) {
        this.bodyResults = bodyResults;
    }

    public cn.backend.service.wsdl.login.RenderEmailTemplateBodyResult getBodyResults(int i) {
        return this.bodyResults[i];
    }

    public void setBodyResults(int i, cn.backend.service.wsdl.login.RenderEmailTemplateBodyResult _value) {
