...
public class DescribeLayoutSection  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.DescribeLayoutRow[] layoutRows;
    ...
    private cn.backend.service.wsdl.login.TabOrderType tabOrder;
    ...
    public DescribeLayoutSection(
           ...
           cn.backend.service.wsdl.login.DescribeLayoutRow[] layoutRows,
           java.lang.String layoutSectionId,
           java.lang.String parentLayoutId,
           int rows,
           cn.backend.service.wsdl.login.TabOrderType tabOrder,
     ...
     * @return layoutRows
     */
    public cn.backend.service.wsdl.login.DescribeLayoutRow[] getLayoutRows() {
        return layoutRows;
    }
     ...
     * @param layoutRows
     */
    public void setLayoutRows(cn.backend.service.wsdl.login.DescribeLayoutRow[] layoutRows) {
        this.layoutRows = layoutRows;
    }

    public cn.backend.service.wsdl.login.DescribeLayoutRow getLayoutRows(int i) {
        return this.layoutRows[i];
    }

    public void setLayoutRows(int i, cn.backend.service.wsdl.login.DescribeLayoutRow _value) {
     ...
     * @return tabOrder
     */
    public cn.backend.service.wsdl.login.TabOrderType getTabOrder() {
        return tabOrder;
    }
     ...
     * @param tabOrder
     */
    public void setTabOrder(cn.backend.service.wsdl.login.TabOrderType tabOrder) {
        this.tabOrder = tabOrder;
    }
