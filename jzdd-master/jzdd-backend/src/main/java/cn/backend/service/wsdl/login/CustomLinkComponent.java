...
public class CustomLinkComponent  extends cn.backend.service.wsdl.login.DescribeLayoutComponent  implements java.io.Serializable {
    private cn.backend.service.wsdl.login.DescribeLayoutButton customLink;
    ...
    public CustomLinkComponent(
           ...
           cn.backend.service.wsdl.login.DescribeLayoutButton customLink) {
        super(
            displayLines,
            tabOrder,
            type,
     ...
     * @return customLink
     */
    public cn.backend.service.wsdl.login.DescribeLayoutButton getCustomLink() {
        return customLink;
    }
     ...
     * @param customLink
     */
    public void setCustomLink(cn.backend.service.wsdl.login.DescribeLayoutButton customLink) {
        this.customLink = customLink;
    }
