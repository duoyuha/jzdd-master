...
public class MatchResult  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.MatchRecord[] matchRecords;
    ...
    public MatchResult(
           ...
           cn.backend.service.wsdl.login.MatchRecord[] matchRecords,
     ...
     * @return matchRecords
     */
    public cn.backend.service.wsdl.login.MatchRecord[] getMatchRecords() {
        return matchRecords;
    }
     ...
     * @param matchRecords
     */
    public void setMatchRecords(cn.backend.service.wsdl.login.MatchRecord[] matchRecords) {
        this.matchRecords = matchRecords;
    }

    public cn.backend.service.wsdl.login.MatchRecord getMatchRecords(int i) {
        return this.matchRecords[i];
    }

    public void setMatchRecords(int i, cn.backend.service.wsdl.login.MatchRecord _value) {
