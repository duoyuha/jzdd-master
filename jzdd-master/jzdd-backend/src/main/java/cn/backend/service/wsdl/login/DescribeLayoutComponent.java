...
public class DescribeLayoutComponent  implements java.io.Serializable {
    ...
    private cn.backend.service.wsdl.login.LayoutComponentType type;
     ...
     * @return type
     */
    public cn.backend.service.wsdl.login.LayoutComponentType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(cn.backend.service.wsdl.login.LayoutComponentType type) {
        this.type = type;
    }
