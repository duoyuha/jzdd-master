...
@ToString
@Entity
@Table(name = "t_complain_order")
@ApiModel(value = "t_complain_order", description = "t_complain_order")
public class ComplainOrderEntity extends BaseEntity{
    ...
    /**
     * 投诉时间 yyyymmdd hhmmss
     */
    //@NotNull(message = "投诉时间 yyyymmdd hhmmss不能为空",groups = {CreateGroup.class, UpdateGroup.class})
    @Column(name="COMPLAIN_TIME")
    @FiledLog(SysConstant.Common.OUTPUT_LOG)
    @ApiModelProperty(value = "投诉时间 yyyymmdd hhmmss", dataType = DataType.STRING)
