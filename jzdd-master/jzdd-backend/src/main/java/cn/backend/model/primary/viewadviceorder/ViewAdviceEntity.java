package cn.backend.model.primary.viewadviceorder;
...
@ToString
@Entity
@Table(name = "v_advice_order")
@ApiModel(value = "v_advice_order", description = "报修订单的视图")
public class ViewAdviceEntity extends BaseEntity {
